<aside class="admin-sidebar" id="adminSidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-item {{ adminRoute('admin.products') }}"><a href="{{ route('admin.products') }}" class="sidebar-link"><i class="fa-solid fa-box"></i><span>Products</span></a></li>
            ...
            <li class="sidebar-item {{ adminRoute('admin.categories') }}"><a href="{{ route('admin.categories') }}" class="sidebar-link"><i class="fa-solid fa-tags"></i><span>Categories</span></a></li>
