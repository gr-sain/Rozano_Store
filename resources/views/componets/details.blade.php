<section class="details section--lg">
    <div class="details__container container grid">
        <div class="details__group">
            <img src="{{  asset('img/product-8-1.jpg') }}" alt="" class="details__img">

            <div class="details__small-images grid">
                <img src="{{ asset('img/product-8-2.jpg') }}" alt="" class="details__small-img">
                <img src="{{ asset('img/product-8-1.jpg') }}" alt="" class="details__small-img">
                <img src="{{ asset('img/product-8-2.jpg') }}" alt="" class="details__small-img">
            </div>
        ...
        <div class="details__group">
            ...
            <p class="short__description">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis sapiente et veniam, a nihil voluptatum natus harum nulla impedit ipsa explicabo saepe eos!
            </p>
            ...
            <div class="details__size flex">
                ...
                <ul class="color__list">
                    <li>
                        <a href="#" class="size__link size__active">M</a>
                    </li>
...
<section class="details__tab container">
    <div class="detail__tabs">
        <span class="detail__tab active__tab" data-target="#info">
            Additional Info
        </span>
        ...
        <div class="details__tab-content" content id="reviews">
            <div class="reviews__container grid">
                <div class="review__single">
                    <div>
                        <img src="{{ asset('img/avatar-1.jpg') }}" alt="" class="review__img">
                    ...
                    <div class="review__data">
                        ...
                        <span class="review__date">Decemder 4, 2020 at 3:12 pm</span>
                    </div>
                </div>
                ...
                <div class="review__single">
                    ...
                    <div class="review__data">
                        ...
                        <p class="review__description">
                            Authentic and Beautiful, Love these way more than ever expected Thay are Great earphones 
                        </p>
            ...
            <div class="review__form">
                ...
                <form action="" class="m-5 form grid">
                    <textarea class="form__input textarea" placeholder="Write Content"></textarea>
    ...
    <div class="product__container grid">
        <div class="product__item">
            <div class="product__banner">
                <a href="#" class="product__images">
                    <img src="{{ asset('img/product-9-1.jpg') }}" alt="" class="product__img">
                    <img src="{{ asset('img/product-9-1.jpg') }}" alt="" class="product__img hover">
                </a>

                <div class="product__actions">
                    <a href="#" class="action__btn" aria-label="Quick Viwe">
            ...
            <div class="product__content">
                ...
                <div class="product__price flex">
                    <span class="new__price">$449.80</span>
                    <span class="old__price">$499.80</span>
                </div>
        ...
        <div class="product__item">
            <div class="product__banner">
                ...
                <div class="product__badge light-orenge">Hot</div>
            </div>
